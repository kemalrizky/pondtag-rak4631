...
// nws key d3 39 7b b5 91 48 fb 2c 3f 73 51 14 58 70 1c 1a

uint8_t node_nws_key[16] = {0xD3,0x39,0x7B,0xB5,0x91,0x48,0xFB,0x2C,0x3F,0x73,0x51,0x14,0x58,0x70,0x1C,0x1A};
// apps key 4f 28 d1 1c 82 f5 bd 2b dc a1 a6 fd ca 54 7c de
uint8_t node_apps_key[16] = {0x4F,0x28,0xD1,0x1C,0x82,0xF5,0xBD,0x2B,0xDC,0xA1,0xA6,0xFD,0xCA,0x54,0x7C,0xDE};
...
void setup_app(void)
{
	...
	g_lorawan_settings.otaa_enabled = false;							// Flag for OTAA or ABP - K: changed, default is true
	...
	g_lorawan_settings.node_dev_addr = 0x4d948ffc;					// ABP Device Address MSB - K: must be configured to match Antares
	g_lorawan_settings.send_repeat_time = 60000;					// Send repeat time in milliseconds: 2 * 60 * 1000 => 2 minutes
	...
	g_lorawan_settings.lora_region = LORAMAC_REGION_AS923_2;		// LoRa region - K: Must be configured to LORAMAC_REGION_AS923_2
